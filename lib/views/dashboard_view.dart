        ...
        children: [
            ...
            builder: (context, snapshot) {
              ...
              if (!idExiste) {
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  if (mounted) setState(() => _concursoSelecionadoId = 'geral');
                });
              }
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final concluidosPorMateria =
                    dadosProgresso['concluidosPorMateria'] as Map<String, int>;
          ...
          StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              final tempoPorDia = estatisticas['tempoPorDia'] as Map<int, int>;
